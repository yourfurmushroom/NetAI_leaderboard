    ...
    render()
    {
        ...
        return (
            ...
            <div style={{
                ...
                <InputField type="username" name="賬號" text={this.state.userName} handler={(e)=>this.TypingUsernameHandler(e)}></InputField>
        ...
        if(this.props.isRegisterPage)
            return (
                ...
                <div style={{
                    ...
                    <h1 style={{display:"inline-block"}}>註冊新賬號</h1>
                    <button style={{padding:"50px"}} type="button" class="btn-close position-absolute top-0 end-0" aria-label="Close" onClick={()=>this.props.reset()}></button>
                    <InputField type="username" name="username" handler={(e)=>this.TypingUsernameHandler(e)}></InputField>
                    <InputField type="password" name="password" handler={(e)=>this.TypingPasswordHandler(e)}></InputField>
                    <InputField type="password" name="comfirm password" handler={(e)=>this.TypingSecondPasswordHandler(e)}></InputField>
