            ...
            return (
                <div style={{
                    ...
                    <div style={{
                        ...
                        <InputField type="username" name="帳號" text={this.state.userName} handler={(e) => this.TypingUsernameHandler(e)} EnterHandler={(e)=>this.EnterHandler(e)}></InputField>
                        <InputField type="password" name="密碼" text={this.state.passWord} handler={(e) => this.TypingPasswordHandler(e)} EnterHandler={(e)=>this.EnterHandler(e)}></InputField>
